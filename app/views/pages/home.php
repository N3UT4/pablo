<main>
  <section class="hero">
    <div class="hero-ornaments" aria-hidden="true">
      <svg class="svg-orbit svg-orbit-one" viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg">
        <circle cx="110" cy="110" r="80" fill="none" stroke="rgba(255,31,61,0.38)" stroke-width="1.5" />
        <circle cx="110" cy="110" r="58" fill="none" stroke="rgba(255,255,255,0.22)" stroke-width="1.1" stroke-dasharray="8 10" />
        <path d="M48 110h124M110 48v124M64 64l92 92M156 64L64 156" stroke="rgba(255,255,255,0.16)" stroke-width="1.2" />
      </svg>
      <svg class="svg-orbit svg-orbit-two" viewBox="0 0 260 260" xmlns="http://www.w3.org/2000/svg">
        <path d="M30 170c30-90 82-130 170-130" fill="none" stroke="rgba(255,31,61,0.5)" stroke-width="2" stroke-linecap="round"/>
        <path d="M52 205c35-62 81-84 164-90" fill="none" stroke="rgba(255,255,255,0.15)" stroke-width="1.4" stroke-linecap="round"/>
        <circle cx="206" cy="54" r="12" fill="rgba(255,31,61,0.8)"/>
        <circle cx="78" cy="219" r="9" fill="rgba(255,255,255,0.18)"/>
      </svg>
    </div>
    <div class="wrap hero-grid">
      <div>
        ...
        <div class="svg-band" aria-hidden="true">
          <svg viewBox="0 0 420 90" xmlns="http://www.w3.org/2000/svg">
            <path d="M10 45h70M110 45h65M205 45h58M290 45h65M370 45h40" stroke="rgba(255,255,255,0.26)" stroke-width="2" stroke-linecap="round"/>
            <circle cx="88" cy="45" r="8" fill="rgba(255,31,61,0.9)"/>
            <circle cx="183" cy="45" r="8" fill="rgba(255,255,255,0.24)"/>
            <circle cx="270" cy="45" r="8" fill="rgba(255,31,61,0.9)"/>
            <circle cx="361" cy="45" r="8" fill="rgba(255,255,255,0.24)"/>
          </svg>
        </div>
      </div>
    ...
    <div class="wrap">
      ...
      <div class="studio-photo-grid">
        <?php foreach ($studioPhotos as $index => $photo): ?>
          ...
          <div class="studio-photo reveal" aria-label="Trabajo de tatuaje del estudio, imagen <?= $index + 1 ?>">
            <img src="img/<?= rawurlencode($photoName) ?>"
                 alt="Trabajo de tatuaje del estudio, imagen <?= $index + 1 ?>"
                 loading="lazy"
                 data-gallery-image="img/<?= rawurlencode($photoName) ?>">
  ...
  <div class="gallery-modal hidden" id="gallery-modal" aria-hidden="true">
    <div class="gallery-modal-backdrop" data-close-gallery="true"></div>
    <div class="gallery-modal-content" role="dialog" aria-modal="true" aria-label="Vista ampliada de la foto">
      <button class="gallery-modal-close" type="button" aria-label="Cerrar vista ampliada">×</button>
      <img id="gallery-modal-image" src="" alt="Vista ampliada de tatuaje del estudio">
    </div>
  </div>
