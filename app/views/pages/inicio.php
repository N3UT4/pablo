  ...
  <section class="services" id="servicios">
    <div class="wrap">
      <div class="sec-head reveal">
        ...
        <img src="img/ornament.svg" class="sec-ornament" alt="">
      </div>
  ...
  <section class="flash">
    <div class="wrap">
      ...
      <div class="flash-grid">
        ...
        <div class="flash-item reveal"><img src="img/heart.svg" alt="Diseño corazón"><span>Corazón tradicional</span></div>
        <div class="flash-item reveal"><img src="img/anchor.svg" alt="Diseño ancla"><span>Ancla marinera</span></div>
        <div class="flash-item reveal"><img src="img/eye.svg" alt="Diseño ojo protector"><span>Ojo protector</span></div>
        <div class="flash-item reveal"><img src="img/wave.svg" alt="Diseño ola"><span>Ola japonesa</span></div>
        <div class="flash-item reveal"><img src="img/thunder.svg" alt="Diseño rayo"><span>Rayo</span></div>
        <div class="flash-item reveal"><img src="img/swallow.svg" alt="Diseño golondrina"><span>Golondrina</span></div>
      </div>
    </div>
  </section>

  <?php
  $studioPhotos = glob(APP_ROOT . '/img/[0-9]*.jpeg') ?: [];
    ...
    <div class="wrap">
      ...
      <div class="studio-photo-grid">
        <?php foreach ($uploadedPhotos as $photo): ?>
          <a class="studio-photo reveal" href="<?= htmlspecialchars($photo['imagen']) ?>" target="_blank" rel="noopener noreferrer">
            <img src="<?= htmlspecialchars($photo['imagen']) ?>"
                 alt="<?= htmlspecialchars($photo['titulo'] ?: 'Trabajo del estudio') ?>"
                 loading="lazy">
            <span class="photo-caption"><?= htmlspecialchars($photo['titulo'] ?: 'ITZA TATTOO') ?></span>
          </a>
        <?php endforeach; ?>
      </div>
    </div>
