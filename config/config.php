...
// Carpeta donde se guardan las fotos subidas desde la galería de staff.
define('GALLERY_UPLOAD_DIR', APP_ROOT . '/img/gallery');
define('GALLERY_UPLOAD_URL', 'img/gallery');
